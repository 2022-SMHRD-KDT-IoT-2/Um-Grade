...
public final class ActivityJoinBinding implements ViewBinding {
  ...
  private ActivityJoinBinding(@NonNull ConstraintLayout rootView, @NonNull ScrollView scrollView2,
  ...
  public static ActivityJoinBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityJoinBinding((ConstraintLayout) rootView, scrollView2, tvJoinTitle);
    }
